...
const JOB_TO_CLASS_MAP: Record<string, MapleClass> = {
  ...
  // Archer jobs
  'bowmaster': MapleClass.ARCHER,
  'marksman': MapleClass.ARCHER,
  'pathfinder': MapleClass.ARCHER,
  'wind-archer': MapleClass.ARCHER,
  'wild-hunter': MapleClass.ARCHER,
  'mercedes': MapleClass.ARCHER,
  'kain': MapleClass.ARCHER,
